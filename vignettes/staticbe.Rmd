...
```{r trendremovalplot, echo = FALSE, fig.height = 4, fig.margin = TRUE}
par(mar = c(2,5,0.5,0.5))
plot(baro_detrend~datetime, transducer, 
     type = 'l', las = 1,
     col = '#BC7C56',  lwd = 2,
     xlab = '', ylab = 'baro detrend (dbar)')

points(wl_detrend~datetime, transducer, 
       type = 'l', las = 1, 
       col = '#5696BC', lwd = 2,
...
```{r leastsquaresplot, echo = FALSE, fig.height = 4, fig.margin = TRUE}
par(mar = c(5,5,0.5,0.5))
plot(wl_detrend~baro_detrend, transducer,
     pch = 20, las = 1,
     cex = 0.05, col = '#000000',
     asp = 1)
grid()
...
```{r leastsquaresdiffplot, echo = FALSE, fig.height = 4, fig.margin = TRUE}
par(mar = c(5,5,0.5,0.5))
plot(diff(wl_detrend, 30)~diff(baro_detrend,30), transducer,
     pch = 20, las = 1,
     cex = 0.05, col = '#000000',
     ylab = 'wl differences',
...
```{r smith, eval = FALSE}
# This function is not evaluated as it makes a large vignette file.
# Please run locally to see the interactive example

library(waterlevel)
data("transducer")
be_visual(transducer,
          dep = 'wl',
          ind = 'baro',
          time = 'datetime',
          be_tests = seq(0.6, 1.0, 0.05),
          inverse = FALSE,
          subsample = TRUE)
```
